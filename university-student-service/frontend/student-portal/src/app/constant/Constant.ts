...
export const LOGIN_API_URL = 'http://backend-alb-173978315.ap-southeast-2.elb.amazonaws.com/api/Auth';
export const COURSE_API_URL : string = 'http://backend-alb-173978315.ap-southeast-2.elb.amazonaws.com/api/course';
export const ENROLMENT_API_URL = 'http://backend-alb-173978315.ap-southeast-2.elb.amazonaws.com/api/Enrolment';
export const STUDENT_DOCUMENTS_API_URL : string = 'http://backend-alb-173978315.ap-southeast-2.elb.amazonaws.com/api/Doc';
export const STUDENT_API_URL : string = 'http://backend-alb-173978315.ap-southeast-2.elb.amazonaws.com/api';
